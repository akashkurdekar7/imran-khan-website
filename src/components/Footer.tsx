...
import next from "/footer/next-project.png";
...
const Footer = () => {
  ...
  return (
    <footer className="relative min-h-screen overflow-hidden z-[9999]">
      <div className="absolute inset-0 bg-gradient-to-t from-[#F26B4F] to-white" />
      <div className="mask absolute inset-0 z-10">
        <Background bgRef={footerBg} />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex flex-col items-center gap-8 pointer-events-none ">
          <div className="grid grid-cols-2 block xl:hidden ">
            <div className="flex flex-col items-start justify-center gap-0">
              <ul className="flex flex-col items-start justify-center gap-0 white text-[10px] text-detai uppercase">
                <span className="block text-start text-lux tracking-[0.2em] uppercase white mb-3  leading-none mb-0 ">
                  Connect
                </span>
                <li>
                  <WaveText
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              <p className="text-lux uppercase white text-[8px]  tracking-[0.2em] leading-none block ">
                other projects
              </p>
              <a
                href=""
                target="_blank"
                className="w-auto h-20 flex flex-col gap-2 items-center justify-center"
              >
                <img
                  src={next}
                  alt=""
                ...
                />
                <span className="text-detai uppercase white text-[8px]  flex gap-4">
                  <span>v</span>
                  <span>o</span>
                  <span>i</span>
                  <span>d</span>
          ...
          <div className="relative z-20 xl:-mb-8 xl:pb-0 pb-5">
            <svg
              viewBox="0 0 850 525"
              fill="none"
              className="xl:w-[170px] w-[120px] h-auto relative z-30"
            ...
            <h3 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 block xl:hidden w-max white text-detai text-[12px] z-10 uppercase text-center ">
              always bringing <br />
              the rush
            </h3>
          </div>
          <h3 className="hidden xl:block w-max white text-detai xl:text-[26px] text-[14px] z-10 uppercase text-center ">
            always bringing <br />
            the rush
          </h3>
          <img
            src={heroImage}
            alt=""
            className="relative z-20 xl:max-w-[500px] max-w-[300px] h-auto object-contain "
          />
        </div>
        <div className="absolute hidden xl:block right-20 top-1/2 -translate-y-1/2 z-20 text-right">
          <p className="text-lux uppercase white text-[12px] mb-6 tracking-widest">
            Connect
          </p>
          <ul className="space-y-1 white text-[18px] text-detai uppercase">
            <li>
              <WaveText
                text="Gmail"
                link="mailto:akash@example.com"
        ...
        <div className="absolute hidden xl:block left-20 bottom-50 z-20">
          <p className="text-lux white uppercase text-[12px] mb-6 tracking-widest text-center">
            other projects
          </p>
          <a
            href=""
            target="_blank"
            className="w-auto h-40 flex  flex-col gap-2 items-center justify-center"
          >
            <img src={next} alt="" className="w-full h-full object-contain" />
            <span className="text-detai uppercase white text-[18px]  flex gap-8">
              <WaveText text="V" className="uppercase" />
              <WaveText text="o" className="uppercase" />
              <WaveText text="i" className="uppercase" />
              <WaveText text="d" className="uppercase" />
            </span>
          </a>
        </div>
      </div>
      <div className="absolute bottom-6 xl:bottom-0  left-1/2 -translate-x-1/2 capitalize black text-detai tracking-widest text-[8px] z-20 flex items-center w-max justify-center">
        <span>© 2026</span>{" "}
        <WaveText
      ...
      <div className="absolute right-10 bottom-6 flex gap-8 text-black text-detai tracking-widest text-[8px] uppercase z-20"></div>
    </footer>
  );
};
